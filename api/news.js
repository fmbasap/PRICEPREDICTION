...
헤드라인은 원문을 그대로 인용하지 말고 본인 언어로 짧게 바꿔 쓰세요 (최대 4개). url은 실제 검색으로 찾은
기사의 정확한 링크만 넣고, 확실하지 않으면 그 항목의 url은 null로 두세요.

{
  "score": 0부터 100 사이의 정수,
  "headlines": [
    { "title": "짧게 바꿔쓴 헤드라인", "source": "출처명", "url": "실제 기사 URL 또는 null" }
  ]
}`;
